                ...
                <div class="w-[100px] h-[40px]">
                    <label for="file_uplaod" class="flex justify-between">
                        <div
                            ...
                            <span class="!px-1">{{ props.buttonLabel }}</span>
                        </div>
                    </label>
                </div>
        ...
        <div class=" grid-cols-1 gap-4">
            <div class="col-span-1">
                <div v-for="(file, index) in allAttachments" :key="index"
                    class="w-[87.5%] place-self-end border-b-1 flex align-center justify-between items-center rounded-[4px]">
                    <div class="flex items-center !pt-2 !pb-2">
                        <Image class="w-[70px] h-[70px] object-scale-down"
                            :src="file.id ? '/public/' + props.path + file?.url : file?.url"
